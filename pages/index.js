  ...
  return (
            ...
            <section className="slide slide1 d-flex align-items-center">
              <div className='container'>
                <div className='slide-content d-grid align-items-end gap-5 gap-md-0 text-responsive'>
                  <div className='mb-5'>
                    <Image src={CreaLight} className='slide-img_creajoven mb-3' alt='Crea Jovem'></Image>
                    <p className='font-mont display-5 fw-bold text-white mb-3'>Oportunidades que impulsionam carreiras!</p>

                    <div>
                      <Image src={LogosSlide} className='slide-img_logos mb-5 mb-md-0'></Image>
                    </div>

                  </div>
                  <div className='mt-5 mt-md-0'>
                    <Button type='button-primary' link={'/times'} text='Conheça nossos times'></Button>
                  </div>
                </div>
              </div>
            </section>
      ...
      <SwiperSlide>
            <section className="slide slide2 d-flex align-items-center">
              <div className='container'>
                <div className='slide-content d-grid align-items-end gap-5 gap-md-0 text-responsive'>
                  <div className='mb-5'>
                    <p className='font-mont display-5 fw-bold text-white mb-3'>Produtos e serviços</p>
                    <p className='subtitle text-white'>Oportunidades para impulsionar sua carreira e criar conexões.</p>
                    <div>
                      <Image src={LogosSlide} className='slide-img_logos mb-5 mb-md-0'></Image>
                    </div>
                  ...
                  <div className='mt-5 mt-md-0'>
                    <Button type='button-primary' link={'/#produtos'} text='Conheça nossos produtos'></Button>
                  </div>
                </div>
              </div>
            </section>
      ...
      <SwiperSlide>
            <section className="slide slide3 d-flex align-items-center">
              <div className='container'>
                <div className='slide-content d-grid align-items-end gap-5 gap-md-0 text-responsive'>
                  <div className='mb-5'>
                    <p className='font-mont display-5 fw-bold text-white mb-3'>Times e áreas</p>
                    <p className='subtitle text-white'>Oportunidades para impulsionar sua carreira e criar conexões.</p>
                    <div>
                      <Image src={LogosSlide} className='slide-img_logos mb-5 mb-md-0'></Image>
                    </div>
    ...
    <section className='container py-3 my-5 about-program'>
      <div className='d-flex flex-column-reverse flex-md-row gap-5 justify-content-center align-items-center h-100'>
        <div className="w-100">
          <video src={'/video/creasc.mp4'} className='video' controls>
          </video>
        </div>
        <div className="w-100">
          <p className='title-2 font-faster_italic'><span className='title-marked'>Programa</span> CREA Jovem-sc</p>
          <p>O Programa CREA JOVEM-SC tem o objetivo de implementar em âmbito estadual  ações direcionadas a capacitação dos profissionais recém-graduados e com até cinco anos de formação nas áreas abrangidas pelo Sistema Confea/Crea, possibilitando-lhes <span className='text-marked'>orientação para ingresso no mercado de trabalho,</span> além de fomentar a participação nas atividades do Sistema e nas entidades de classe.</p>
          <div className='mt-4 mt-md-5'>
            <Link href='pdf/Regras-CREA-Jovem-SC-2023.pdf' target="blank" className={`button button-primary`}>
              <button>
    ...
    <section className='d-md-flex py-md-5 justify-content-center'>
        <div className='box-skew'>
          <div className="content-left">
            <p className="title-3"><span className='title-marked2'>Benefícios</span></p>
            <p>Estreitar as relações do Crea-SC com os jovens profissionais, contribuindo na sua <span className='fw-bold'>qualificação</span>, estabelecendo <span className='fw-bold'>parcerias, convênios e apoiando movimentos</span> inovadores e empreendedores.</p>
          </div>
        ...
        <div className='box-skew mt-3 mt-md-5'>
          <div className="content-right">
            <p className="title-3"><span className='title-marked2'>Para quem</span>  se destina?</p>
            <p>Para <span className='fw-bold'>profissionais recém-graduados</span> e com até <span className='fw-bold'>cinco anos de formação</span> nas áreas abrangidas pelo Sistema Confea/Crea, com registro regular no CREA-SC.</p>
          </div>
    ...
    <div className='container'>
                <div className='slide-content d-grid align-items-end gap-5 gap-md-0 text-responsive'>
                  <div className='mb-5'>
                    <p className='font-mont display-6 fw-bold text-white mb-3'>Junte-se a nós, escolha o seu time e não fique de fora!</p>
    ...
    <section className='py-5 section-teams'>
      <div className='container section-teams_content mb-4 mb-md-0'>
        ...
        <div className='section-teams_header d-md-flex gap-5 align-items-center'>
              <p className="title-2 font-faster"><span className='title-marked'>Times</span></p>
              <p>O programa está dividido em <span className='text-marked'>times que respondem por temas e áreas</span> específicas que compõem o objetivo geral da sua criação. São elas:</p>
        </div>
        ...
        <div className='show-desk'>
          <div className='d-grid gap-2 py-5 justify-content-center'>
            ...
            <div className='row gap-2'>
              ...
              link={'/times?selec=legislação-e%20valorização%20profissional'}>
              </BoxTeam>
            </div>
    ...
    <section className='py-5 my-5 section-cta section-cta_inscription'>
      <div className='container d-md-flex justify-content-center align-items-center section-cta_inscription-bg p-5'>
        <div className='w-100 text-white ps-0 ps-md-5'>
          <p className='title'><span className='title-marked2 fw-bold'>Como posso</span> me inscrever?</p>
          <p>O jovem profissional interessado em participar deverá se inscrever <span className='fw-bold'>acessando o seu Creanet profissional</span> , preencher o formulário disponível, escolher seu time e justificar sobre sua intenção e motivação de participação no time escolhido.</p>
        </div>
    ...
    <section className='container pt-5 mt-5' id='produtos'>
      <div className='section-teams_header d-md-flex gap-5 align-items-center pt-5 pt-md-0'>
                <p className="title-2 font-faster" id='produtos'><span className='title-marked'>Produtos</span></p>
                <p>Os produtos e serviços a seguir são oportunidades para <span className='text-marked'>impulsionar sua carreira e criar conexões.</span></p>
        </div>
    </section>
    ...
    <div class="modal fade" id="mailModal" tabindex="-1" role="dialog" aria-labelledby="mailModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg"  role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="mailModalTitle">Enviar um email</h5>
            <button style={{border:'none',backgroundColor:'white'}} onClick={closeModal} type="button" class="close"  aria-label="Close">
          ...
          <form id = "form-email-form" >
            <div class = "form-email-box">
              <div style={{marginTop:'0px'}} class="form-group form-email">
                <label for="subject">Assunto</label>
                <input required type="text" class="form-control" id="subject"  placeholder="Saiba mais: SEBRAE-SC"/>
              </div>

              <div class="form-group form-email">
                <label for="message">Mensagem</label>
                <textarea required type="text" class="form-control" id="message" placeholder="Olá, gostaria de saber mais sobre o produto SEBRAE-SC.">Olá, gostaria de saber mais sobre o produto SEBRAE-SC.</textarea>
              </div>
              ...
              <div class="form-group form-email">
                <button data-dismiss = "modal" type='submit' class="btn btn-primary d-flex justify-content-center">
                  <span id = "text-form">Enviar email</span>
                  <div id='spinner-form' style={{display:'none',width:'24px',height:'24px'}} class="spinner-border" role="status"></div>
      ...
      clase='section-products_slide slide'>
        ...
        <BoxProduct
          ...
          link={' https://portal.crea-sc.org.br/servicos/bolsa-de-empregos/'}
          clase={isActive ? 'box-product_active' : 'box-product'}
          >
        </BoxProduct>)}
        </SwiperSlide>
        ...
        <BoxProduct
          ...
          link={'https://portal.crea-sc.org.br/divulgacao/convenios/contrato-unimed/adesao-de-usuario-titular-profissional-registrado-ou-academico-do-crea-jr/'}
          clase={isActive ? 'box-product_active' : 'box-product'}
          >
        </BoxProduct>)}
        </SwiperSlide>
    ...
    <section className='container pb-5 my-5'>
      <div className=''>
          ...
          <div className='d-flex flex-column flex-md-row justify-content-center gap-5 align-items-center'>
            ...
            <Image src={LogoCredcrea} alt='Credcrea' className='img-logo'></Image>
